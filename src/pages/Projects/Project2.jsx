...
import myImage from "../../assets/images/blanko_trade_1.png";
...
const Project2 = ({ direction, onDragEnd }) => {
  return (
    <motion.div
    ...
    >
      <Reveal className="container flex flex-row items-center justify-center max-lg:space-y-8 max-lg:flex-col gap-8">
        <SequentialAnimations className="lg:flex-[3] flex flex-row items-center justify-center gap-2 overflow-hidden">
          <img
            src={myImage2}
            alt="Opis zdjęcia"
        ...
        <SequentialAnimations
          delay={0.4}
          className="flex flex-col lg:flex-[2] items-end justify-end"
        >
