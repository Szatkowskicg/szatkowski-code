...
const Project1 = ({ direction, onDragEnd }) => {
  return (
    <motion.div
      ...
      onDragEnd={onDragEnd}
    >
      <Reveal className="container flex flex-row items-center justify-center max-lg:space-y-8 max-lg:flex-col">
        <SequentialAnimations className="flex flex-col lg:flex-[2]">
          <h1 className="h1 font-bold mb-4">Smokin’s Loyalty App</h1>
          <p className="pl-8 text-lg">Description for project 1</p>
          <Button
            className="text-xl"
            onClick={(e) => {
        ...
        <SequentialAnimations
          delay={0.8}
          className="lg:flex-[3] flex flex-row items-center justify-center gap-2 overflow-hidden"
        >
          <img
            src={myImage}
            alt="Opis zdjęcia"
